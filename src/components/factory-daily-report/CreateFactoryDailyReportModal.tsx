        ...
        >
            <View style={styles.content}>
                ...
                <View style={styles.row_container}>
                    ...
                    {
                        isCompleted && listMechanicReport.map((item, index) => {
                            return (
                                <View style={{
                                    marginTop: 20,
                                    flexDirection: 'row',
                                ...
                                >
                                    ...
                                    />
                                    <PrimaryDropdown
                                        data={item.type === 0 ? mechanicRuleReport0.map((item: any) => {
                                            return {
                                                label: item.product_name,
                                                value: item.id,
                                            };
                                        }) : item.type === 1 ? mechanicRuleReport1.map((item: any) => {
                                                return {
                                                    label: item.product_name,
                                                    value: item.id,
                                                };
                                        ...
                                        isSearch={false}
                                    />
                                    <Text style={[fs_15_400, text_black]}>HT</Text>
                                    <TextInput
                                        style={[styles.input, {
                                            width: 45,
                                        }]}
                                        ...
                                        placeholder={'SL'}
                                    />
                                    <Text style={[fs_15_400, text_black]}>= 150 kpi</Text>
                                </View>
                            )
                        })
                    }

                    {
                        ...
                        <TouchableOpacity onPress={() => {
                            setListMechanicReport([...listMechanicReport, {
                                type: -1,
                                mechanicRuleReport: 0,
                                mechanicQuantity: '',
                            }])
                        }}>
                            <Text style={[fs_15_400, {
                                color: '#0070FF',
                                textAlign: 'center',
                                marginTop: 20
                            }]}>Thêm</Text>
