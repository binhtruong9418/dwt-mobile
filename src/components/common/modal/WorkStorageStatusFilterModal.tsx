...
import {
    ...
    WORK_STATUS_COLOR, WORK_STORAGE_STATUS, WORK_STORAGE_STATUS_COLOR,
} from '../../../assets/constant.ts';

export default function WorkStorageStatusFilterModal(
    {
        visible,
        setVisible,
        setStatusValue,
        statusValue,
    }: InferProps<typeof WorkStorageStatusFilterModal.propTypes>) {
    ...
    const handleSaveValue = () => {
        setStatusValue(
            WORK_STORAGE_STATUS.find(item => item.value === currentFilter.value),
        );
        setVisible(false);
    };
    return (
        <ReactNativeModal
            ...
            <View style={styles.content}>
                ...
                <View style={styles.row_container}>
                    {WORK_STORAGE_STATUS.map((item: any, index) => (
                        <View
                            key={index}
                            style={[
                                styles.row,
...
WorkStorageStatusFilterModal.propTypes = {
