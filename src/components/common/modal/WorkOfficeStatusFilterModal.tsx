...
import {
    LIST_WORK_OFFICE_STATUS_FILTER,
    LIST_WORK_STATUS_FILTER,
    WORK_STATUS_COLOR,
} from '../../../assets/constant.ts';

export default function WorkOfficeStatusFilterModal({
                                                  visible,
                                                  setVisible,
                                                  setStatusValue,
                                                  statusValue,
                                              }: InferProps<typeof WorkOfficeStatusFilterModal.propTypes>) {
    ...
    const handleSaveValue = () => {
        setStatusValue(
            LIST_WORK_OFFICE_STATUS_FILTER.find(item => item.value === currentFilter),
        );
        setVisible(false);
    };
    return (
        <ReactNativeModal
            ...
            <View style={styles.content}>
                ...
                <View style={styles.row_container}>
                    {LIST_WORK_OFFICE_STATUS_FILTER.map((item: any, index) => (
                        <View
                            key={index}
                            style={[
                                styles.row,
...
WorkOfficeStatusFilterModal.propTypes = {
