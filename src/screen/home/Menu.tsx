...
import {fs_10_400, fs_15_700, mb20, row_between, text_black, text_center, text_red} from "../../assets/style.ts";
    ...
    <SafeAreaView style={styles.wrapper}>
        ...
        >
            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.boxContainer} onLayout={(e) => {
                    ...
                    <View style={styles.box}>
                        {
                            hanhchinhData.map((item, index) => (
                                ...
                                >
                                    {item.icon}
                                    <Text style={[
                                        fs_10_400, text_red, text_center, {
                                        marginTop: 5,
                                    }]}>{item.name}</Text>
                                </TouchableOpacity>
                            ))
